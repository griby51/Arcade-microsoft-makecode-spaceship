...
statusbar = statusbars.create(70, 4, StatusBarKind.Health)
statusbar.setColor(7, 2)
statusbar.max = 3
statusbar.setPosition(46, 11)
forever(function () {
    controller.moveSprite(mySprite, 100, 0)
})
forever(function () {
    projectile2 = sprites.createProjectileFromSide(projectile_texture._pickRandom(), 0, 100)
    projectile2.setPosition(randint(160, 0), -3)
